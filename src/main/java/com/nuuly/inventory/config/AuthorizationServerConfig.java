...
// OAuth2 Authorization Server configuration — disabled.
// Re-enable by uncommenting @Configuration and all @Bean methods below,
// and re-enabling SecurityConfig#authorizationServerFilterChain.
...
public class AuthorizationServerConfig {
    ...
    // Client: inventory-client / inventory-secret
    // Scopes: inventory.read, inventory.write
    // Grant: client_credentials  |  Token TTL: 10 min
    // @Bean
